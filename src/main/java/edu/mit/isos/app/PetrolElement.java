...
/**
 * Common interface to a petroleum system element.
 * 
...
public interface PetrolElement extends Element {
	...
	/**
	 * Gets the quantity of petroleum sent to the electricity system.
	 *
	 * @return the quantity of petroleum sent
	 */
	public double getPetrolSentToElect();
	
	/**
	 * Gets the quantity of petroleum sent to the social system.
	 *
	 * @return the quantity of petroleum sent
	 */
